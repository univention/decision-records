...
From [section _Sensitive data_ in the logging concept](logging/logging_concept.md#sensitive-data):
...
This example exists as a script that you can run: [logging/log_errors.py](logging/log_errors.py).
