...
[univention_logging.py](logging/univention_logging.py).

There is also a package hierarchie and a test script that can be executed to verify its functionality: [level_conf.py](logging/level_conf.py):
